...
x_20 = l_Lean_throwError___at_Lean_IR_UnboxResult_initFn____x40_Lean_Compiler_IR_UnboxResult___hyg_3____spec__2(x_19, x_2, x_3, x_8);
return x_20;
}
else
{
...
x_35 = l_Lean_throwError___at_Lean_IR_UnboxResult_initFn____x40_Lean_Compiler_IR_UnboxResult___hyg_3____spec__2(x_34, x_2, x_3, x_23);
return x_35;
}
else
{
...
lean_inc(x_15);
lean_dec(x_5);
x_16 = lean_mk_string("recursive inductive datatypes are not supported");
x_17 = l_Lean_stringToMessageData(x_16);
lean_dec(x_16);
x_18 = l_Lean_throwError___at_Lean_AttributeImpl_erase___default___spec__1(x_17, x_2, x_3, x_15);
return x_18;
}
}
else
...
lean_inc(x_19);
lean_dec(x_5);
x_20 = lean_mk_string("constant must be an inductive type");
x_21 = l_Lean_stringToMessageData(x_20);
lean_dec(x_20);
x_22 = l_Lean_throwError___at_Lean_AttributeImpl_erase___default___spec__1(x_21, x_2, x_3, x_19);
return x_22;
}
}
else
...
x_2 = lean_box(0);
x_3 = lean_mk_string("unbox");
x_4 = lean_name_mk_string(x_2, x_3);
x_5 = lean_mk_string("compiler tries to unbox result values if their types are tagged with `[unbox]`");
x_6 = lean_alloc_closure((void*)(l_Lean_IR_UnboxResult_initFn____x40_Lean_Compiler_IR_UnboxResult___hyg_3____lambda__1___boxed), 4, 0);

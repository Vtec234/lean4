...
x_20 = l_Lean_Syntax_setArg(x_1, x_19, x_18);
return x_20;
}
}
}
...
lean_inc(x_3);
lean_inc(x_1);
x_18 = l_Lean_Elab_getDeclarationRange___rarg(x_1, x_3, x_5);
lean_inc(x_17);
x_19 = lean_alloc_closure((void*)(l_Lean_Elab_addDeclarationRanges___rarg___lambda__2), 7, 6);
